...
<link rel="stylesheet" type="text/css" href="../resources/assets/css/jquery.datetimepicker.css"/>

<!-- jquery.js is required but it already exists in assets/js. 
	 Importing it again causes a crash and toTop link to not work.

	<script src="../resources/assets/js/datetimepicker/jquery.js"></script>
...
<%
	...
	if(pageName.equalsIgnoreCase("logout.jsp"))
	{
		session.invalidate();
	}
